...
class Movement_Goal(metaclass=Metaclass_Movement_Goal):
    ...
    __slots__ = [
        '_movement_type',
        '_translation_setpoint',
        '_rotation_setpoint',
    ]

    _fields_and_field_types = {
        'movement_type': 'int8',
        'translation_setpoint': 'double',
        'rotation_setpoint': 'double',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.translation_setpoint = kwargs.get('translation_setpoint', float())
        self.rotation_setpoint = kwargs.get('rotation_setpoint', float())
    ...
    def __eq__(self, other):
        ...
        if self.movement_type != other.movement_type:
            return False
        if self.translation_setpoint != other.translation_setpoint:
            return False
        if self.rotation_setpoint != other.rotation_setpoint:
            return False
        return True
    ...
    def movement_type(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'movement_type' field must be an integer in [-128, 127]"
        self._movement_type = value

    @property
    def translation_setpoint(self):
        """Message field 'translation_setpoint'."""
        return self._translation_setpoint

    @translation_setpoint.setter
    def translation_setpoint(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'translation_setpoint' field must be of type 'float'"
        self._translation_setpoint = value

    @property
    def rotation_setpoint(self):
        """Message field 'rotation_setpoint'."""
        return self._rotation_setpoint

    @rotation_setpoint.setter
    def rotation_setpoint(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'rotation_setpoint' field must be of type 'float'"
        self._rotation_setpoint = value
...
class Metaclass_Movement_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robot_interfaces.action import Movement
...
class Movement_SendGoal_Request(metaclass=Metaclass_Movement_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robot_interfaces/Movement_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'action'], 'Movement_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_interfaces.action._movement import Movement_Goal
...
class Metaclass_Movement_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Movement_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_interfaces.action import _movement
...
class Movement_SendGoal(metaclass=Metaclass_Movement_SendGoal):
    from robot_interfaces.action._movement import Movement_SendGoal_Request as Request
    from robot_interfaces.action._movement import Movement_SendGoal_Response as Response
...
class Movement_GetResult_Response(metaclass=Metaclass_Movement_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robot_interfaces/Movement_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'action'], 'Movement_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_interfaces.action._movement import Movement_Result
...
class Metaclass_Movement_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Movement_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Movement_GetResult(metaclass=Metaclass_Movement_GetResult):
    from robot_interfaces.action._movement import Movement_GetResult_Request as Request
    from robot_interfaces.action._movement import Movement_GetResult_Response as Response
...
class Metaclass_Movement_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Movement_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Movement_FeedbackMessage(metaclass=Metaclass_Movement_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robot_interfaces/Movement_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'action'], 'Movement_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robot_interfaces.action._movement import Movement_Feedback
...
class Metaclass_Movement(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Movement')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Movement(metaclass=Metaclass_Movement):
    ...
    from robot_interfaces.action._movement import Movement_Goal as Goal
    # The result message defined in the action definition.
    from robot_interfaces.action._movement import Movement_Result as Result
    # The feedback message defined in the action definition.
    from robot_interfaces.action._movement import Movement_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robot_interfaces.action._movement import Movement_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robot_interfaces.action._movement import Movement_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robot_interfaces.action._movement import Movement_FeedbackMessage as FeedbackMessage
